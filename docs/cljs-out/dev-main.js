var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=59d3ca&fwbuild=dev"};
...
document.write('<script>goog.require("reagent_d3.core");</script>');
